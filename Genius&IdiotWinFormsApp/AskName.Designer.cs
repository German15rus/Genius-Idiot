namespace Genius_IdiotWinFormsApp
{
	partial class AskName
	{
		...
		private void InitializeComponent()
		{
			...
			UserName.Location = new Point(214, 153);
			UserName.Name = "UserName";
			UserName.Size = new Size(349, 39);
			UserName.TabIndex = 1;
			UserName.TextChanged += UserName_TextChanged;
			// 
			// NameButton
			// 
			NameButton.Font = new Font("Segoe UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point, 204);
			NameButton.Location = new Point(304, 225);
			NameButton.Name = "NameButton";
			NameButton.Size = new Size(168, 53);
